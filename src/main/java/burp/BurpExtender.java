...
public class BurpExtender implements IBurpExtender, IScannerCheck, IContextMenuFactory {
    ...
    public static String Download_Yaml_file = "/adminwaf/RouteVulScan/main/Config_yaml.yaml";
    ...
    public void registerExtenderCallbacks(IBurpExtenderCallbacks callbacks) {
        ...
        call.printOutput("@From: Code by adminwaf");
        call.printOutput("@Github: https://github.com/adminwaf/RouteVulScan");
    ...
    public List<JMenuItem> createMenuItems(IContextMenuInvocation invocation) {
        ...
        JMenuItem one_menu = new JMenuItem("Send To ApiScan");
